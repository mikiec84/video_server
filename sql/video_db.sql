...
`PWD` TEXT,
`ICON` VARCHAR(64) DEFAULT 'jon_snow.png'
...
SELECT COMMENTS.ID, USERS.LOGIN_NAME, USERS.ICON, 
	COMMENTS.CONTENT, COMMENTS.TIME FROM COMMENTS 
	INNER JOIN USERS ON COMMENTS.AUTHOR_ID = USERS.ID
	WHERE COMMENTS.VIDEO_ID='524842a2-475a-0296-c403-9c818a1b6ed8' AND COMMENTS.TIME > FROM_UNIXTIME(0) 
	AND COMMENTS.TIME <= NOW()
